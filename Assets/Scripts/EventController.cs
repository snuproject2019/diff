...
public class EventController : MonoBehaviour
{
    ...
    public void SetTools(){
        ...
        ToolCards[0].GetComponent<ToolSelect>().tool = new Tool(new Eq("d", new Eq("^", new Eq("e"), new Eq("★"))),new Eq(" \\times ", new Eq("^", new Eq("e"), new Eq("★")), new Eq("d", new Eq("★"))));
        ToolCards[0].GetComponent<ToolSelect>().setTool();
        ToolCards[1].GetComponent<ToolSelect>().tool = new Tool(new Eq("d", new Eq("sin", new Eq("★"))),new Eq(" \\times ", new Eq("cos", new Eq("★")), new Eq("d", new Eq("★"))));
        ToolCards[1].GetComponent<ToolSelect>().setTool();
        ToolCards[2].GetComponent<ToolSelect>().tool = new Tool(new Eq("d", new Eq("cos", new Eq("★"))),new Eq(" \\times ", new Eq("-sin", new Eq("★")), new Eq("d", new Eq("★"))));
        ToolCards[2].GetComponent<ToolSelect>().setTool();
        ToolCards[3].GetComponent<ToolSelect>().tool = new Tool(new Eq("d", new Eq("^", new Eq("★"), new Eq(m.ToString()))),new Eq(" \\times ", new Eq(m.ToString()), new Eq(" \\times ", new Eq("^", new Eq("★"), new Eq((m-1).ToString())), new Eq("d", new Eq("★")))));
        ToolCards[3].GetComponent<ToolSelect>().setTool();
        ToolCards[4].GetComponent<ToolSelect>().tool = new Tool(new Eq("d", new Eq(" \\times ", new Eq(n.ToString()), new Eq("★"))),new Eq(" \\times ", new Eq(n.ToString()), new Eq("d", new Eq("★"))));
        ...
        ToolCards[6].GetComponent<ToolSelect>().tool = new Tool(new Eq("d", new Eq(" \\times ", new Eq("★"), new Eq("◎"))),new Eq("+", new Eq(" \\times ", new Eq("◎"), new Eq("d", new Eq("★"))), new Eq(" \\times ", new Eq("★"), new Eq("d", new Eq("◎")))));
        ToolCards[6].GetComponent<ToolSelect>().setTool();
        ToolCards[7].GetComponent<ToolSelect>().tool = new Tool(new Eq("d", new Eq(nz)),new Eq("\\times ", new Eq("/", new Eq("d", new Eq(nz)), new Eq("d", new Eq(z))), new Eq("d", new Eq(z))));
        ToolCards[7].GetComponent<ToolSelect>().setTool();
    }
